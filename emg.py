...
if __name__ == "__main__":
    ...
    try:
        ...
        clocksync_flag_dict = {
            "80:30:DC:E9:25:07": False,
            "34:B1:F7:D2:35:97": False,
            "34:B1:F7:D2:35:9D": False,
            "34:14:B5:51:D1:6B": False,
        }
        ...
        params = pika.URLParameters(
            "amqps://yjxagmuu:9i_-oo9VNSh5w4DtBxOlB6KLLOMLWlgj@mustang.rmq.cloudamqp.com/yjxagmuu"
        )
        ...
        while True:
            with concurrent.futures.ThreadPoolExecutor(max_workers=1) as data_executor:
                ...
                if len(BUFFER) > 0:
                    ...
                    t1 = time.time()
                    emg_data = str(t1) + "|" + database_emg_data + "|"
                    print(emg_data)
